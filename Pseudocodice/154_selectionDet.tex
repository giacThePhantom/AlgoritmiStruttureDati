...
\comment{Divide $A$ in $\bigl\lceil\frac{n}{5}\bigr\rceil$ sottovettori di dimensione $5$ e ne calcola la mediana}
M = \New \Int$\bigl[1\dots \bigl\lceil\frac{n}{5}\bigr\rceil\bigr]$\;
\For{\Int i = 1 \To $\bigl\lceil\frac{n}{5}\bigr\rceil$}{
	M[i] = \Median{A, start + $(i - 1)\cdot 5$, end}\;
}
\comment{Individua la mediana delle mediane e la si usa come perno}
\Item m = \Selection{M, 1, $\bigl\lceil\frac{n}{5}\bigr\rceil$, $\bigl\lceil\frac{\lceil\frac{n}{5}\rceil}{2}\bigr\rceil$}\;
